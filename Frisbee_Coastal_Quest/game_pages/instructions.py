...
class Instructions(Mesh):
    def __init__(self):
        geometry = RectangleGeometry(1, 1)
        grid_texture = Texture(file_name="images/black.png")
        ...
        message2 = TextTexture(text="- Shoot all bottles to clear the level ",
                               font_file_name="fonts/ALGER.TTF",
                               background_color=[255,255,255,0],
        ...
        message3 = TextTexture(text="- Clear all 4 levels to win                            ",
                               font_file_name="fonts/ALGER.TTF",
                               background_color=[255,255,255,0],
                               font_size=32, font_color=[255, 255, 255],
                               image_width=768, image_height=256,
        ...
        message4 = TextTexture(text="- Aim the frisbee using the Arrow Keys   ",
                               font_file_name="fonts/ALGER.TTF",
                               background_color=[255,255,255,0],
                               font_size=32, font_color=[255, 255, 255],
                               image_width=768, image_height=256,
        ...
        message5 = TextTexture(text="- Throw the frisbee with the Space Key    ",
                               font_file_name="fonts/ALGER.TTF",
                               background_color=[255,255,255,0],
                               font_size=32, font_color=[255, 255, 255],
                               image_width=768, image_height=256,
        ...
        message6 = TextTexture(text="- Be careful with the wind                              ",
                               font_file_name="fonts/ALGER.TTF",
                               background_color=[255,255,255,0],
                               font_size=32, font_color=[255, 255, 255],
                               image_width=768, image_height=256,
