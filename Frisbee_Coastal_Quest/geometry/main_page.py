...
class MainPageMesh(Mesh):
    def __init__(self):
        geometry = RectangleGeometry(1.5, 1)
        grid_texture = Texture(file_name="images/capa.png")
        ...
        message1 = TextTexture(text="Press [Enter] to continue",
        ...
        message2 = TextTexture(text="Press [Esc] to quit",
                               system_font_name="Algerian",
                               font_file_name = "fonts/ALGER.TTF",
                               background_color=[255,255,255,0],
        ...
        message3 = TextTexture(text="Shoot The Target",
