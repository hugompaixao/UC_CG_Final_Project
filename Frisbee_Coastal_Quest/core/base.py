...
class Base:
    def __init__(self, screen_size=(800, 600)):#, fullscreen=True):
        ...
        # Set display mode based on fullscreen parameter
        #if fullscreen:
        #    self._screen = pygame.display.set_mode((0, 0), display_flags | pygame.FULLSCREEN)
        #else:
        ...
        pygame.display.set_caption("Frisbee Coastal Quest")
